...
namespace WuMalphite
{
    ...
    {
        public static Version AssVersion;//Kappa
        public static readonly String CN = "Malphite";
        public static Spell.Targeted Smite = null;
        public static Spell.Targeted Ignite = null;
        public static AIHeroClient Player { get { return ObjectManager.Player; } }

        public static Item BOTRK, Randuin, Bilgewater, Tiamat, Hydra, Glory, FOTMountain, Mikael;
        public static Menu Menu;
        public static Vector2 Player2D = new Vector2();
        public static Dictionary<Vector2, int> PosAndHits;
        ...
        public static Spell.Active E = new Spell.Active(SpellSlot.E, 400);
        public static Spell.Skillshot R = new Spell.Skillshot(SpellSlot.R, 1000, SkillShotType.Circular, 250, 700, 270);
